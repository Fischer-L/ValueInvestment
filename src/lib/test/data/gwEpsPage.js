...
<head>
    <meta charset="utf-8">
    <title>台積電(2330)每股盈餘財報 | 台股 | </title>
    <meta name="viewport" content="width=device-width,initial-scale=1.0"/>


    <meta property="og:title" content="台積電(2330)每股盈餘財報 | 台股 | " />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://www.gw.com/stock/report/basic_eps?stockno=2330" />
    <meta property="og:image" content="https://www.gw.com/images/gw-og-default.jpg" />
    <meta property="og:site_name" content="" />
    <meta name="description" content="台積電(2330)每股盈餘財報，提供每股盈餘與每季收盤價比較，包含季增率、年增率等最新動態，更多台積電(2330)財報資訊盡在" />
    <meta property="og:description" content="台積電(2330)每股盈餘財報，提供每股盈餘與每季收盤價比較，包含季增率、年增率等最新動態，更多台積電(2330)財報資訊盡在" />
...
<header id="header">
    <div class="head">
        <div class="brand" style="top: 10px;">
            <a href="/">
                <img src="/images/gw-logo-2019.svg" alt="gw" width="120">
            </a>
        </div><!-- brand:end -->
...
<li id='HeaderTextAd_4'><a href='http://bit.ly/2pwivmf'>百億操盤手被拐來開社團？</a></li>
...
<div id="container" class="clearfix">
        ...
        <div class="gwAdv adsbox ads1000x90" name="1000x90個股" id="6057d2c1-f295-4717-ab81-82754e0aceb4">
                        <a href="//www.gw.com/admin/backoffice/adclick?id=6057d2c1-f295-4717-ab81-82754e0aceb4" title="老漁夫小資翻身 " target="_blank">
                            <img src="https://img.gw.com/gwfiles/banner/936536ba-27cc-4209-b014-c0fdfe6ad23d.gif" alt="老漁夫小資翻身 ">
                        </a>
        </div>
        ...
        <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="">
                        <a itemprop="item" href="https://www.gw.com/">
                            <span itemprop="name"></span>
                        </a>
                    <meta itemprop="position" content="1" />
                </li>
                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="">
                        <a itemprop="item" href="https://www.gw.com/stock">
                            <span itemprop="name">台股</span>
                        </a>
                    <meta itemprop="position" content="2" />
                </li>
                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="">
                        <a itemprop="item" href="https://www.gw.com/stock/2330">
                            <span itemprop="name">台積電(2330)</span>
                        </a>
                    <meta itemprop="position" content="3" />
                </li>
                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="">
                        <a itemprop="item" href="https://www.gw.com/stock/report/basic_mr?stockno=2330">
                            <span itemprop="name">財報股利</span>
                        </a>
                    <meta itemprop="position" content="4" />
                </li>
                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="active">
                        <a itemprop="item" href="https://www.gw.com/stock/report/basic_eps?stockno=2330">
...
<footer class="site-footer">
    <div class="site-footer-inner">
        ...
        <div class="site-social">
            <a href="https://www.facebook.com/gw.fans" onclick="sentEvent('點擊FB粉絲團', 'Footer', 'NoLogging', {'dimension3':'0'});" title="就是愛玩股粉絲團" target="_blank" rel="noopener noreferrer" class="ic-fb"></a>
        </div><!-- /site-social -->
